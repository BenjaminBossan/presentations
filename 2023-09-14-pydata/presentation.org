...
* Wrap-up
** Conclusion
- Learned how skorch helps to combine sklearn and the HF ecosystem
- What was shown is only part of what is possible
- Of course, the different techniques and libraries can be combined (e.g. tokenizers + transformers + accelerate + PEFT)
** Links:
